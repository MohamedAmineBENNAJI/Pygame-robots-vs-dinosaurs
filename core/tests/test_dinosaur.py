...
class TestDinosaur:
    ...
    def test_update(
        self, dinosaur_object: Dinosaur, direction: int, expected_position: int
    ) -> None:
    ...
    def test_basic_health(
        self,
        dinosaur_object: Dinosaur,
        current_health: int = 30,
        health_ratio: float = 2,
    ) -> None:
...
class TestMonster:
    ...
    def test_update(
        self, monster_object: Monster, speed: int, expected_position: int
    ) -> None:
        """This method tests the update function for the Dinosaurs."""
    ...
    def test_get_damage(
        ...
        assert (
            remaining_health == expected_health
        ), "Check the Monster damage function !"

    def test_basic_health(
        self, monster_object: Monster, current_health: int = 30, health_ratio: float = 5
    ) -> None:
