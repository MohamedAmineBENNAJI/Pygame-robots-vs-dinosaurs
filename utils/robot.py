...
class Robot(pygame.sprite.Sprite):
    ...
    def __init__(
        ...
        super().__init__()
        self.screen = screen
        self.image = pygame.image.load("assets/images/robot.png").convert_alpha()
    ...
    def get_input(self):
        """This  method is used to get the keyboard inputs and convert them into actions."""
    ...
    def get_health(self, amount: int):
        """This method is used to calculate the health of robot after hitting a dinosaur with an amount of damage.
        Args:
            amount: the amount of taken damage."""
    ...
    def update(self):
        """This method is used to update the positions, recharge the weapon and calculate the robot's health."""
        self.get_input()
        self.constraint()
        self.recharge()
        self.lasers.update()
